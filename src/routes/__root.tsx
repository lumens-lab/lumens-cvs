...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#001535" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { title: "lumens — Secured Chat & Payments" },
      ...
      { property: "og:title", content: "lumens — Secured Chat & Payments" },
      ...
      { name: "twitter:title", content: "lumens — Secured Chat & Payments" },
      { name: "twitter:description", content: "Lumens: send money, set budgets, manage your expenses, scan to pay and chat with friends." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/zYPpD5bNEXhp5A6FtvNXkWcJ8fC3/social-images/social-1780657828506-lumens_icon-_blue.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/zYPpD5bNEXhp5A6FtvNXkWcJ8fC3/social-images/social-1780657828506-lumens_icon-_blue.webp" },
    ],
    links: [
      {
        rel: "stylesheet",
