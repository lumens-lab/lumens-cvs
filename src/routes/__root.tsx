...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "lumens | Messaging & Wallet" },
      ...
      { name: "twitter:title", content: "lumens | Messaging & Wallet" },
      { name: "twitter:description", content: "Lumens: send money, set budgets, manage your expenses, scan to pay and chat with friends." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/zYPpD5bNEXhp5A6FtvNXkWcJ8fC3/social-images/social-1780929728582-lumens_icon-_blue-1.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/zYPpD5bNEXhp5A6FtvNXkWcJ8fC3/social-images/social-1780929728582-lumens_icon-_blue-1.webp" },
    ],
    links: [
      {
        rel: "stylesheet",
